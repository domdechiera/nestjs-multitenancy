...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  private async createTenantConnections() {
    for (const [tenantid, connectionString] of Object.entries(
      ...
      await this.createTenantConnecton(tenantid, connectionString);
      this.runMigrations(tenantid, connectionString);
    }
  }

  private async createTenantConnecton(
    tenantId: string,
  ...
  private async runMigrations(tenantId: string, connectionString: string) {
